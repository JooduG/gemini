...
| ---------------- | --------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Strategy**     | Vision, blueprints, structural specifications | [Planning](./config/skills/planning/SKILL.md), [Modern Web Guidance](./config/skills/modern-web-guidance/SKILL.md), [Context](./config/skills/context/SKILL.md), `deepwiki`, [Developer Database](./config/skills/developer-database/SKILL.md) |
...
| **Sensory**      | Optics, UI/UX, CSS, Audio                     | [Modern Web Guidance](./config/skills/modern-web-guidance/SKILL.md), [Stitch](./config/skills/stitch/SKILL.md), `StitchMCP`, [Chrome DevTools](./config/skills/devtools/SKILL.md), `perchance-plugin-image`                                    |
