...
- **Docs & Web Guidance**: Fetch library patterns via [Context](./config/skills/context/SKILL.md) and [Modern Web Guidance](./config/plugins/modern-web-guidance-plugin/skills/modern-web-guidance/SKILL.md).
...
| ---------------- | --------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Strategy**     | Vision, blueprints, structural specifications | [Planning](./config/skills/planning/SKILL.md), [Modern Web Guidance](./config/plugins/modern-web-guidance-plugin/skills/modern-web-guidance/SKILL.md), [Context](./config/skills/context/SKILL.md), `deepwiki`, [Developer Database](./config/skills/developer-database/SKILL.md) |
