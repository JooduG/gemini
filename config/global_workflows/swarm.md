...
- [Developer Database](../skills/developer-database/SKILL.md): Memory Protocol grounding.
...
2. **Context Recovery**: Retrieve the **Global Mission Kernel** from Pinecone. Ensure the shared architectural constraints are identified. [[Invoke: Developer Database]](../skills/developer-database/SKILL.md)
