...
| :---------------- | :------------------------------------- | :------------------------------------------------------------------ |
| **/00-status**    | Session Initialization & Monitoring    | [00-status.md](../../../config/global_workflows/00-status.md)       |
| **/01-plan**      | Tactical Planning & Eternal Foundation | [01-plan.md](../../../config/global_workflows/01-plan.md)           |
| **/02-implement** | Incremental Tactical Implementation    | [02-implement.md](../../../config/global_workflows/02-implement.md) |
| **/03-review**    | Quality Gate & Verification            | [03-review.md](../../../config/global_workflows/03-review.md)       |
| **/04-release**   | releaseasep & Handoff (Perchance)      | [04-release.md](../../../config/global_workflows/04-release.md)     |
